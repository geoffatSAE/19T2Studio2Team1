...
namespace TO5.Wires.Legacy
{
    ...
    /// </summary>
    [Obsolete]
    public class SparkJumperLegacy : MonoBehaviour
    {
        /// <summary>
        ...
        private SparkLegacy m_PendingSpark;               // The spark we are jumping to

        /// <summary>
        /// Jumps to given spark (unless already jumping
        /// </summary>
        /// <param name="spark"></param>
        public void JumpToSpark(SparkLegacy spark)
        {
            //if (m_JumpingToSpark)
              //  return;
        ...
        private IEnumerator TransitionToSpark(SparkLegacy spark)
        {
        ...
        protected void TraceSpark(Ray ray)
        {
            ...
            if (Physics.Raycast(ray, out hit, Mathf.Infinity, Physics.AllLayers, QueryTriggerInteraction.Collide))
            {
                ...
                SparkLegacy spark = hitObject.GetComponent<SparkLegacy>();
